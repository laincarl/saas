...
import EnvPipelineStore from 'stores/envPipeline';
import DeploymentPipelineStore from 'stores/deploymentPipeline';
...
class DepPipelineEmpty extends Component {
  handleClick = () => {
    ...
    const {
      projectId, name, organizationId, type, 
  ...
  render() {
    const {
      intl: { formatMessage }, title, type, callback, 
    } = this.props;
      ...
      <Fragment>
        ...
        <Content>
          <div className="c7n-depPi-empty-card">
            {type === 'env' && env === 'owner' && (
            <Card title={formatMessage({ id: 'envPl.create' })}>
              <div className="c7n-noEnv-content">
                ...
                <a
                  ...
                  target="_blank"
                >
                  <FormattedMessage id="depPl.more" />
            ...
            {type === 'env' && env === 'member' && (
            <Card title={formatMessage({ id: 'depPl.noPermission' })}>
              <FormattedMessage id="depPl.noPerDes" />
              <br />
            ...
            {type === 'app' && (
            <Card title={formatMessage({ id: 'app.create' })}>
              <div className="c7n-noEnv-content">
