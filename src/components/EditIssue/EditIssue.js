            ...
            <div>
              ...
              >
                ...
                <div style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                  <span style={{ marginRight: 12, marginLeft: 63 }}>更新时间</span>
                  <span style={{ width: 60, display: 'inline-block' }}>
                    {
                      branch.lastUpdateDate ? (
                        <Popover
                          title="提交修改时间"
                          content={moment(branch.lastUpdateDate).format('YYYY-MM-DD hh:mm:ss')}
                          placement="left"
                        >
                          <TimeAgo
                            date={moment(branch.lastUpdateDate).format('YYYY-MM-DD hh:mm:ss')}
